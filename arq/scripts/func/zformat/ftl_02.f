...
# Formateo v3_base (ft2 and st2) - Capitulo 027
# ==============================================
...
if [ "${DESIRED_LENGTH_02}" == "" ] ; then
DESIRED_LENGTH_02=20
fi
...
SPACES=$(expr  ${DESIRED_LENGTH_02} - ${INFO_LENGTH} )

if [ $SPACES -gt 0 ] ; then
echo "${INFO}$(printf %${SPACES}s)"
else
echo "${INFO} - [ needed format adjust 02 !! ]"
fi
